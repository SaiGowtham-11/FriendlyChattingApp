...
import 'package:ichat_app/allScreens/setting_page.dart';
                      ...
                      return Container(
                        ...
                        child: CircularProgressIndicator(
                          ...
                          value: loadingProgres.expectedTotalBytes != null &&
                                 loadingProgres.expectedTotalBytes != null
                                 ?loadingProgres.cumulativeBytesLoaded / loadingProgres.expectedTotalBytes! : null,
                        )
                      );
                    },
